            ...
            <div class="form-group col-sm-10 col-md-10 col-xl-10">
                ...
                <div class="form-group col-sm-10 col-md-10 col-xl-10">
                    ...
                    <div class="custom-control custom-radio custom-control-inline">
                        ...
                        <label class="custom-control-label" for="customRadioInline1">Cliente</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" id="customRadioInline2" name="customRadioInline1" class="custom-control-input">
                        <label class="custom-control-label" for="customRadioInline2">Vendedor</label>
                    </div>

                </div>
                <div class="form-group col-sm-3 col-md-3 col-xl-3">
